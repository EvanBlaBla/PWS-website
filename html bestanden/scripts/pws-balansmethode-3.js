...
function balansMethode3() {
  ...
  let a3 = Math.floor(Math.random() * 201) - 100; 
  let b3 = Math.floor(Math.random() * 201) - 100;
  ...
  function vraag3AGenereren() {
    ...
    ${Math.abs(c3-1)}/${Math.abs(c3)}x + ${b3} = ${a3 + b3} ${d3} 1/${e3}x`;
    //let resultaat3A = '';
    console.log(c3, d3, e3, computerAntwoord3A);
